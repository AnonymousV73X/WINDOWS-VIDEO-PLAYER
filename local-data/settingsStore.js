...
const DEFAULT_SETTINGS = {
  // Theme — NovaTune-style dark/light, VLC orange default
  theme: 'dark',                       // 'dark' | 'light'
  accentColor: '#FF8800',              // VLC orange (default)
  backgroundMode: 'dim',               // 'amoled' (pure black) | 'dim' (#121212)
  ...
  hwAccel: true,                       // enable hardware acceleration (--avcodec-hw=any)
